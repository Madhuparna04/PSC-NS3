...
#ifndef PSC_SL_FF_MAC_SCHEDULER_H
#define PSC_SL_FF_MAC_SCHEDULER_H
...
class PscSlFfMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
  ...
  /// allow MemberCschedSapProvider<PscSlFfMacScheduler> class friend access
  friend class MemberCschedSlSapProvider<PscSlFfMacScheduler>;
  /// allow MemberSchedSapProvider<PscSlFfMacScheduler> class friend access
  friend class MemberSchedSapProvider<PscSlFfMacScheduler>;
