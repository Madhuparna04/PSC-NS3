...
#include <ns3/psc-sl-ff-mac-scheduler.h>
...
NS_LOG_COMPONENT_DEFINE ("PscSlFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (PscSlFfMacScheduler);


PscSlFfMacScheduler::PscSlFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_nextRntiDl (0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new MemberCschedSlSapProvider<PscSlFfMacScheduler> (this);
  m_schedSapProvider = new MemberSchedSapProvider<PscSlFfMacScheduler> (this);
}
...
TypeId
PscSlFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PscSlFfMacScheduler")
    .SetParent<FfMacScheduler> ()
    .SetGroupName ("Lte")
    .AddConstructor<PscSlFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&PscSlFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&PscSlFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15]",
                   UintegerValue (0),
                   MakeUintegerAccessor (&PscSlFfMacScheduler::m_ulGrantMcs),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("Itrp",
                   "The Time Resource Pattern Index (iTRP) for PSSCH.",
                   UintegerValue (0),
                   MakeUintegerAccessor (&PscSlFfMacScheduler::m_slItrp),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("SlGrantSize",
                   "The number of RBs allocated per UE for Sidelink",
                   UintegerValue (1),
                   MakeUintegerAccessor (&PscSlFfMacScheduler::m_slGrantSize),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("PscImp",
                   "Importance given to PSC Applications",
                   UintegerValue (2),
                   MakeUintegerAccessor (&PscSlFfMacScheduler::psc_imp),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("MaxUEs",
                   "Maximum number of UEs in one subframe",
                   UintegerValue (0),
                   MakeUintegerAccessor (&PscSlFfMacScheduler::max_ues),
                   MakeUintegerChecker<uint8_t> ())
...
void
PscSlFfMacScheduler::SetFfMacCschedSapUser (FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
PscSlFfMacScheduler::SetFfMacSchedSapUser (FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

FfMacCschedSapProvider*
PscSlFfMacScheduler::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

FfMacSchedSapProvider*
PscSlFfMacScheduler::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
PscSlFfMacScheduler::SetLteFfrSapProvider (LteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

LteFfrSapUser*
PscSlFfMacScheduler::GetLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
PscSlFfMacScheduler::DoCschedCellConfigReq (const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PscSlFfMacScheduler::DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
PscSlFfMacScheduler::DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PscSlFfMacScheduler::DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PscSlFfMacScheduler::DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
...
void
PscSlFfMacScheduler::DoCschedPoolConfigReq (const struct  FfMacCschedSapProvider::CschedPoolConfigReqParameters& params)
{
...
void
PscSlFfMacScheduler::DoCschedPoolReleaseReq (const struct  FfMacCschedSapProvider::CschedPoolReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this << params.m_group);
  std::map <uint32_t, PoolInfo>::iterator it = m_poolAllocations.find (params.m_group);
...
void
PscSlFfMacScheduler::DoCschedDiscPoolConfigReq (const struct FfMacCschedSapProvider::CschedDiscPoolConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PscSlFfMacScheduler::DoCschedDiscPoolReleaseReq (const struct FfMacCschedSapProvider::CschedDiscPoolReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
void
PscSlFfMacScheduler::DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
PscSlFfMacScheduler::DoSchedDlPagingBufferReq (const struct FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
void
PscSlFfMacScheduler::DoSchedDlMacBufferReq (const struct FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
PscSlFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
bool
PscSlFfMacScheduler::SortRlcBufferReq (FfMacSchedSapProvider::SchedDlRlcBufferReqParameters i,FfMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
uint8_t
PscSlFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
PscSlFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
PscSlFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
PscSlFfMacScheduler::DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
...
void
PscSlFfMacScheduler::DoSchedDlRachInfoReq (const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PscSlFfMacScheduler::DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PscSlFfMacScheduler::DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
...
void
PscSlFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
PscSlFfMacScheduler::DoSchedUlSrInfoReq (const struct FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
PscSlFfMacScheduler::DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PscSlFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
PscSlFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
PscSlFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
  std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
...
void
PscSlFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
PscSlFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
